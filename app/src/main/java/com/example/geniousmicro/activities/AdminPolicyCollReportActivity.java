...
public class AdminPolicyCollReportActivity extends AppCompatActivity {
    ActivityAdminPolicyCollectionReportBinding binding;
    private int fdate = 0;
    private int tdate = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAdminPolicyCollectionReportBinding.inflate(getLayoutInflater());
        ...
        binding.searchbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(binding.EmplyCode.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(AdminPolicyCollReportActivity.this, "Please Enter Employee Code", Toast.LENGTH_SHORT).show();
                }else {
                    if (fdate != 0 && tdate != 0) {
                        TotalAmt=0;
                        // withdrawAmt=0;
                        ...
                        Toast.makeText(AdminPolicyCollReportActivity.this, "Please Select Dates", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private void getSBTrasactionDetails() {
        ...
        map.put("ArrangerCode", binding.EmplyCode.getText().toString());
        map.put("Fdate", "" + fdate);
        map.put("Tdate", "" + tdate);
       // Log.e("TEST1",""+ApiLinks.GET_POLICYSUMMARYDATEWISE+GlobalUserData.employeeDataModel.getEmployeeID()+fdate+tdate);
        new PostDataParserObjectResponse(AdminPolicyCollReportActivity.this, ApiLinks.GET_POLICYSUMMARYDATEWISE, map, new VolleyCallback() {
            @Override
                ...
                try {
                    ...
                    for (int i = 0; i < jsa.length(); i++) {
                        if(jsa.getJSONObject(i).getString("Status").equals(status)) {
                            ...
                            list.add(model);
                           /* TotalAmt+=jsa.getJSONObject(i).getDouble("PaidAmoun");
                            Log.e("TotalAmt1",""+jsa.getJSONObject(i).getDouble("PaidAmoun"));
*/
                        }
                        
                    }
                    if (list.size()>0){
                        adapter=new ArrMemPolicyStatementAdapter(list, AdminPolicyCollReportActivity.this);
                        LinearLayoutManager llm=new LinearLayoutManager(AdminPolicyCollReportActivity.this);
                      ...
                      //  binding.totalWith.setText("0");
                        Toast.makeText(AdminPolicyCollReportActivity.this, "No Data Found", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    Toast.makeText(AdminPolicyCollReportActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    Log.d("EX", e.toString());
                }
            }
...
//                getMemberDetails("all", "k");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(AdminPolicyCollReportActivity.this, AdminDashboardActivity.class));
