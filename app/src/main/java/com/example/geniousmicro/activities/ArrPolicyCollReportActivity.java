...
public class ArrPolicyCollReportActivity extends AppCompatActivity {
    ActivityPolicyCollectionReportBinding binding;
    private int fdate = 0;
    private int tdate = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPolicyCollectionReportBinding.inflate(getLayoutInflater());
            ...
            public void onClick(View v) {
                ...
                if (fdate != 0 && tdate != 0) {
                   ...
                   // withdrawAmt=0;
                    ...
                    Toast.makeText(ArrPolicyCollReportActivity.this, "Please Select Dates", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void getSBTrasactionDetails() {
        ...
        new PostDataParserObjectResponse(ArrPolicyCollReportActivity.this, ApiLinks.GET_POLICYSUMMARYDATEWISE, map, new VolleyCallback() {
            @Override
            public void onSuccessResponse(JSONObject result) {
                try {
                    ...
                    if (list.size()>0){
                        adapter=new ArrMemPolicyStatementAdapter(list, ArrPolicyCollReportActivity.this);
                        LinearLayoutManager llm=new LinearLayoutManager(ArrPolicyCollReportActivity.this);
                      ...
                      //  binding.totalWith.setText("0");
                        Toast.makeText(ArrPolicyCollReportActivity.this, "No Data Found", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    Toast.makeText(ArrPolicyCollReportActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    Log.d("EX", e.toString());
                }
            }
