...
import com.example.geniousmicro.databinding.ActivityAdminChainReportBinding;
...
public class AdminChainReportActivity extends AppCompatActivity {
    ActivityAdminChainReportBinding binding;
    private int fdate = 0;
    private int tdate = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAdminChainReportBinding.inflate(getLayoutInflater());
        ...
        binding.searchbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fdate != 0 && tdate != 0) {
                    ...
                    Toast.makeText(AdminChainReportActivity.this, "Please Select Dates", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void getSBTrasactionDetails(String EmplyCode) {
        ...
        new PostDataParserObjectResponse(AdminChainReportActivity.this, ApiLinks.GET_LOANDUE_REPORT, map, new VolleyCallback() {
            @Override
...
*/
                    ...
                    if (list.size()>0){
                        adapter=new AdminLoanDueReportAdapter(list, AdminChainReportActivity.this);
                        LinearLayoutManager llm=new LinearLayoutManager(AdminChainReportActivity.this);
                     ...
                     /*   binding.transRec.setVisibility(View.VISIBLE);
                      ...
                      /*  binding.transRec.setVisibility(View.GONE);
                        ...
                        Toast.makeText(AdminChainReportActivity.this, "No Data Found", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    Toast.makeText(AdminChainReportActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    Log.d("EX", e.toString());
                }
            }
...
//                getMemberDetails("all", "k");
    ...
    public void onBackPressed() {
        //super.onBackPressed();
      //  Intent intent = getIntent();
        startActivity(new Intent(AdminChainReportActivity.this, AdminDashboardActivity.class));
