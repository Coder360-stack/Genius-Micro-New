...
public class ArrTodayPolicyCollReportActivity extends AppCompatActivity {

    ActivityArrTodayPolicyCollReportBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityArrTodayPolicyCollReportBinding.inflate(getLayoutInflater());
        ...
        binding.searchbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                list.clear();
                TotalAmt=0;
                getTodayPolicyCollection(GlobalUserData.employeeDataModel.getEmployeeID(),status);
            }
        });
        ...
        try {
            if (cn != null) {
                ...
                if (rs.isBeforeFirst()){
                    ...
                    adapter = new TodayPolicyCollAdapter( list,ArrTodayPolicyCollReportActivity.this);
                    LinearLayoutManager llm=new LinearLayoutManager(ArrTodayPolicyCollReportActivity.this);
                    ...
                    Toast.makeText(ArrTodayPolicyCollReportActivity.this, "No Data Found", Toast.LENGTH_SHORT).show();
                }

            }else{

                Toast.makeText(ArrTodayPolicyCollReportActivity.this, "Some Error Occurred", Toast.LENGTH_SHORT).show();
            }
        } catch (Exception e) {
    ...
    public void onBackPressed() {
        //super.onBackPressed();
        startActivity(new Intent(ArrTodayPolicyCollReportActivity.this, MainActivity.class));
