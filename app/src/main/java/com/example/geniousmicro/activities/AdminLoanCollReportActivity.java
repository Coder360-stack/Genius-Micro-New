...
public class AdminLoanCollReportActivity extends AppCompatActivity {
    ActivityAdminLoanCollectionReportBinding binding;
    private int fdate = 0;
    private int tdate = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAdminLoanCollectionReportBinding.inflate(getLayoutInflater());
                ...
                if (fdate != 0 && tdate != 0) {
                    ...
                    if (intent.getStringExtra("LoanCollectionType") != null &&  Objects.equals(intent.getStringExtra("LoanCollectionType"), "AdminArangerWiseReport")) {
                       ...
                       if (binding.EmplyCode.getText().toString().isEmpty()){
                           ...
                           Toast.makeText(AdminLoanCollReportActivity.this, "Please Enter Employee Code", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AdminLoanCollReportActivity.this, "Please Select Dates", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void getSBTrasactionDetails(String EmplyCode) {
      ...
      //  Log.e("TEST1",""+ApiLinks.GET_LOANSUMMARYDATEWISE+GlobalUserData.employeeDataModel.getEmployeeID()+fdate+tdate);
        new PostDataParserObjectResponse(AdminLoanCollReportActivity.this, ApiLinks.GET_LOANSUMMARYDATEWISE, map, new VolleyCallback() {
            @Override
            public void onSuccessResponse(JSONObject result) {
                try {
                    ...
                    if (list.size()>0){
                        adapter=new LoanStatementDatewiseAdapter(list, AdminLoanCollReportActivity.this);
                        LinearLayoutManager llm=new LinearLayoutManager(AdminLoanCollReportActivity.this);
                      ...
                      //  binding.totalWith.setText("0");
                        Toast.makeText(AdminLoanCollReportActivity.this, "No Data Found", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    Toast.makeText(AdminLoanCollReportActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    Log.d("EX", e.toString());
                }
            }
...
//                getMemberDetails("all", "k");
    ...
    public void onBackPressed() {
        ...
        Intent intent = getIntent();
      if(  intent.getStringExtra("LoanCollectionType") != null &&  Objects.equals(intent.getStringExtra("LoanCollectionType"), "AdminArangerWiseReport")) {
          startActivity(new Intent(AdminLoanCollReportActivity.this, AdminDashboardActivity.class));
          overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
          finish();

      }else {
          startActivity(new Intent(AdminLoanCollReportActivity.this, MainActivity.class));
          overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
          finish();
      }
