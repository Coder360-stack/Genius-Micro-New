...
import com.example.geniousmicro.databinding.ActivityArrLoandueReportBinding;
...
public class ArrLoanDueReportActivity extends AppCompatActivity {
    ActivityArrLoandueReportBinding binding;
    private int fdate = 0;
    private int tdate = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityArrLoandueReportBinding.inflate(getLayoutInflater());
            ...
            public void onClick(View v) {
                ...
                if (fdate != 0 && tdate != 0) {
                 ...
                 /*   Intent intent = getIntent();
                    ...
                    Toast.makeText(ArrLoanDueReportActivity.this, "Please Select Dates", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }

    private void getArrLoanDueReport(String EmplyCode) {
        TotalAmt=0;
        ...
        new PostDataParserObjectResponse(ArrLoanDueReportActivity.this, ApiLinks.GET_LOANDUE_REPORT, map, new VolleyCallback() {
            @Override
...
*/
                    ...
                    if (list.size()>0){
                        adapter=new AdminLoanDueReportAdapter(list, ArrLoanDueReportActivity.this);
                        LinearLayoutManager llm=new LinearLayoutManager(ArrLoanDueReportActivity.this);
                        ...
                        Toast.makeText(ArrLoanDueReportActivity.this, "No Data Found", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    Toast.makeText(ArrLoanDueReportActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    Log.d("EX", e.toString());
                }
            }
...
//                getMemberDetails("all", "k");
    ...
    public void onBackPressed() {
        //super.onBackPressed();
            ...
            startActivity(new Intent(ArrLoanDueReportActivity.this, MainActivity.class));
