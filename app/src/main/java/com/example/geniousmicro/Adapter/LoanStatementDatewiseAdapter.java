...
public class LoanStatementDatewiseAdapter extends RecyclerView.Adapter<LoanStatementDatewiseAdapter.LoanStatementViewHolder> {

    ArrayList<LoanStatementDatewiseModel> list;
    Context context;

    public LoanStatementDatewiseAdapter(ArrayList<LoanStatementDatewiseModel> list, Context context) {
        this.list = list;
    ...
    @Override
    public void onBindViewHolder(@NonNull LoanStatementDatewiseAdapter.LoanStatementViewHolder holder, int position) {
        LoanStatementDatewiseModel model = list.get(position);
